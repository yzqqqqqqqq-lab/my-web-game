...
const ProductCard = ({
  ...
  return (
    <Link
      href={href}
      className={`group p-0.5 relative flex-1 rounded-[6px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 ${hoverBorder} transform hover:-translate-y-[10px]`}
      style={{
        background: gradient,
      }}
    >
    ...
    <div className={classNames}>
      ...
      <div className="md:hidden  mx-auto py-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-white font-bold text-lg">开始玩</h2>
        </div>
