...
// Mobile Logo Component (S letter)
export const StakeLogoMobile = ({ className }: { className?: string }) => (
  <svg
...
export const SpecialIcon = ({ className }: { className?: string }) => (
  <svg
...
// VIPNone Icon Component (星形轮廓)
export const VIPNoneIcon = ({ className }: { className?: string }) => (
  <svg
...
// VIPBronze Icon Component (青铜星形)
export const VIPBronzeIcon = ({ className }: { className?: string }) => (
  <svg
...
export const SidebarToggleIcon = ({
  ...
  >
    <path
      fill="currentColor"
      d="M21 1H3c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2m-8 18.78c0 .67-.55 1.22-1.22 1.22H4.22C3.55 21 3 20.45 3 19.78V4.22C3 3.55 3.55 3 4.22 3h7.56c.67 0 1.22.55 1.22 1.22z"
    />
  </svg>
);
...
export const VaultIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      fill="currentColor"
      d="M20 2H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2v2h4v-2h8v2h4v-2c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2m-7 8.79V15c0 .55-.45 1-1 1s-1-.45-1-1v-4.21c-.88-.39-1.5-1.26-1.5-2.29a2.5 2.5 0 0 1 5 0c0 1.02-.62 1.9-1.5 2.29"
    />
  </svg>
);
...
// MyBets Icon Component
export const MyBetsIcon = ({ className }: { className?: string }) => (
  <svg
    data-ds-icon="MyBets"
    width="20"
    height="20"
...
export const LogoutIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      fill="currentColor"
      d="M16 13H3c-.55 0-1-.45-1-1s.45-1 1-1h13c.55 0 1 .45 1 1s-.45 1-1 1"
    />
    <path
      fill="currentColor"
      d="M8 18.66c-.26 0-.51-.1-.71-.29L.93 12l6.36-6.36A.996.996 0 1 1 8.7 7.05L3.75 12l4.95 4.95a.996.996 0 0 1-.71 1.7z"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M20 2h-8v7h4c1.66 0 3 1.34 3 3s-1.34 3-3 3h-4v7h8c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2"
      clipRule="evenodd"
    />
  </svg>
);
...
// Mobile Footer Icons
// Browse Icon Component
export const BrowseIcon = ({ className }: { className?: string }) => (
  <svg
    data-ds-icon="Browse"
    width="20"
    height="20"
...
// Basketball Icon Component (Sports)
...
// Chat Icon Component (alias for ChatBubbleLeftRightIcon)
